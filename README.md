...
```
Assuming I could set up a way to access this page (something which never happened), this seemed like an extremely simple way to get persistence. 

## UART and the BIOS
Unfortunately, I didn't find anything cool or sexy like unprivelleged RCE, although the BGW210 does have some pins on the board which allow for shell access over a serial cable. So, I got my hands on a guinea pig BGW210 and a TTL to USB adapter, and started soldering. [this writeup](https://gist.github.com/quonic/fab50d7e0979ab21675150a15957cb66) explains the disassembly pretty thoroughly, although the exploit it describes is no longer functioning, and you can't downgrade anymore either.<br><img width="604" height="532" alt="image" src="https://github.com/user-attachments/assets/cdbf8381-3391-4dde-ba9a-01269e6ee67b" /><br>^ my abysmal soldering job :/ <br><br>
